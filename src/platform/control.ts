...
export const policyFields = [
 ...
 {key:'studioPublicationEnabled',label:'İncelenmiş metinleri yayımlama',help:'Yeni toplu uygulamaları durdurur. Daha önceki yayını geri alma çalışmaya devam eder.',permission:'ai'},
