...
export function PlatformAi({branches,role}:{branches:Branch[];role:string}){
 ...
 return <main className="platform-ai"><header><MenuGoLogo alt="MenüGO" width="280" height="74"/><Link className="btn" href="/platform">Şirket kontrol merkezi</Link><Link className="btn" href="/platform/kabul">AI kabul durumu</Link></header>
