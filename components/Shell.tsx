...
export function Brand(){return <Link className="brand" href="/"><img src="/media/menugo-transparent-r8.png" alt="menügo — Yeni Nesil Dijital Menü" width="560" height="147"/></Link>;}
