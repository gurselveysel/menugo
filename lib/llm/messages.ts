export const llmMessages:Record<string,string>={
 LLM_FREE_SETTINGS_REQUIRED:'Yeni Ücretsiz AI bağlantıları ekranını kullanın.',
 LLM_PAID_PROVIDER_BLOCKED:'Ücretli sağlayıcılar ve otomatik kredi alımı kapalı.',
 LLM_FREE_PLAN_RECONFIRM:'Sağlayıcı hesabının Free planda ve faturalandırmanın kapalı olduğunu tekrar doğrulayın.',
 LLM_NO_ELIGIBLE_FREE_ROUTE:'Bu işin görüntü/metin ve gizlilik koşullarını karşılayan ücretsiz bağlantı yok. İşletme Asistanı bağlantılarını kontrol edin.',
 ...
 LLM_SERVER_REQUIRED:'Ücretsiz AI bağlantısı henüz yapılandırılmadı. İşletme Asistanı bağlantı alanından ücretsiz hesap anahtarınızı ekleyin.',
