-- Platform-only AI control overrides. Runs after free-router/free-AI schema exists.
-- This split makes fresh migration replay deterministic while preserving the already-applied production ledger.
BEGIN;
