...
export const MODELS:Record<string,readonly string[]>={openai:['gpt-4.1-mini','gpt-4.1'],gemini:['gemini-2.5-flash']};
...
export function validateRequest(input:unknown){
 ...
 return {businessId,branchId,operationId,kind:v.kind as 'test'|'assistant'|'menu-extract',request};
}
